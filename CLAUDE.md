# Durable Execution Slides — Atlanta Java User Group 2026
...
- Remote/phone control: `cd slides && npx slidev --remote <password>`, then open `http://<laptop-ip>:3030/presenter` on the phone. `./bin/present.sh` prints the URL + QR.
